...
class AIHandler:
    ...
    async def generate_response(self, prompt: str, personality: str = None, 
        ...
        try:
            ...
            enhanced_prompt = self._enhance_prompt_with_personality(prompt, current_personality, context)
    ...
    def _enhance_prompt_with_personality(self, prompt: str, personality: str, 
                                       context: Dict[str, Any] = None) -> str:
        ...
        personality_instruction = personality_instructions.get(
            personality, 
            personality_instructions["friendly"]
        )
        ...
        if context:
            if context.get('platform'):
                ...
                if platform == 'twitch':
                    enhanced_parts.append("This is for Twitch chat - keep responses concise and engaging.")
                elif platform == 'discord':
                    enhanced_parts.append("This is for Discord - you can be more detailed if needed.")
    ...
    async def generate_contextual_response(self, message: str, user_context: Dict[str, Any], 
                                         memories: List[str] = None) -> str:
        ...
        if user_context:
            ...
            if user_context.get('interests'):
                interests = ', '.join(user_context['interests'][-3:])  # Last 3 interests
    ...
    async def process_command(self, command: str, args: List[str], 
        ...
        if command == "help":
            ...
            prompt = "Tell a clean, family-friendly joke that would be appropriate for chat"
